    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, help_text='Введите название страны', max_length=35, null=True, verbose_name='страна')),
            ...
            options={
                ...
                'permissions': [('can_view_user', 'Может просматривать пользователей'), ('can_delete_user', 'Может удалить пользователя')],
            },
            managers=[
